                ...
                if (x==1){
                    ...
                    x=Integer.parseInt(JOptionPane.showInputDialog("    You have selected 5.00 GHC. \n" +
                        ...
                        if (x==1){
                            ...
                            JOptionPane.showMessageDialog(null,"    The amount of 5.00 GHC has been added to your account. \n\n"
                    ...
                    if (x==1){
                        ...
                        JOptionPane.showMessageDialog(null,"    The amount of 4.00 GHC has been added to your account. \n\n"
                    ...
                    if (x==1) {
                        ...
                        if (x==1){
                            ...
                            JOptionPane.showMessageDialog(null,"    The amount of 3.00 GHC has been added to your account. \n\n"
                        ...
                        if (x==1){
                            ...
                            JOptionPane.showMessageDialog(null,"    The amount of 2.00 GHC has been added to your account. \n\n"
